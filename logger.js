...
log4js.configure({
    ...
    categories: {
        ...
        /*
                application: { appenders: [ 'application' ], level: 'ERROR'}
        */
    }
})

exports.access = log4js.getLogger('access') //记录所有访问级别的日志
//exports.access = () => log4js.koaLogger(log4js.getLogger('access'))
/*
